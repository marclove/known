...
pub use config::{
    add_directory_to_config, add_directory_to_config_file, get_config_file_path, load_config,
    load_config_from_file, remove_directory_from_config, remove_directory_from_config_file,
    save_config, Config,
};
